...
|002-1|Соответствие внешнего вида кнопок управления воспроизведения их функциям|Попользоваться UI и субъективно оценить очевидность действий и внешнего вида кнопок и остальных элементов интерфейса|Внешний вид элементов UI интуитивно отображает действия, связанные с их использованием|||
